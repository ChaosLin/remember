...
- (void)layoutSubviews
{
    ...
    if (self.selected)
    {
//        self.checkmarkImageView.image = [UIImage imageNamed:@"AGIPC-Checkmark-iPhone@2x.png"];
        self.checkmarkImageView.backgroundColor = [UIColor blueColor];
    }
    else
    {
//        self.checkmarkImageView.image = [UIImage imageNamed:@"icon_iwant_choose_photo_add.png"];
        self.checkmarkImageView.backgroundColor = [UIColor clearColor];
    }
