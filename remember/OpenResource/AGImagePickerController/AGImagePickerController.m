...
andShouldShowSavedPhotosOnTop:(BOOL)shouldShowSavedPhotosOnTop
{
    ...
    if (self)
    {
        ...
        AGIPCAlbumsController* rootVC = [[AGIPCAlbumsController alloc] initWithImagePickerController:self];
        AGIPCAssetsController *controller = [[AGIPCAssetsController alloc] initWithImagePickerController:self andAssetsGroup:nil];
        
        self.viewControllers = @[rootVC, controller];
    }
