...
- (void)photoViewReviewButtonTapped:(MJPhotoView*)photoView
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(photoBrowser:didClickReviewButtonAtIndex:)])
    {
        [self.delegate photoBrowser:self didClickReviewButtonAtIndex:-1];
    }
}
